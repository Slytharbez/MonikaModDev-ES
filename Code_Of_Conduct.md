...
- 💡 Los colaboradores y otros miembros pueden dejar reseñas, pero estas solo serán consideradas sugerencias y deben ser tratadas como tales.     
...
Los responsables de este proyecto de traducción, en consonancia con los estándares de comportamiento establecidos por los desarrolladores oficiales de Monika After Story, son aquellos que deben aclarar los estándares de comportamiento aceptable y deben tomar acciones correctivas apropiadas y justas en casos de incumplimiento.  
...
Este Código de Conducta está basado en el del repositorio oficial de [Monika After Story](https://github.com/Monika-After-Story/MonikaModDev/blob/master/CODE_OF_CONDUCT.md), el cual hemos traducido y adaptado para ajustarlo a nuestro enfoque como equipo de traducción.  
...
> Fecha de creación: [20/07/2025](https://github.com/The-Encoders-Club/Monika-After-Story-ES/commit/f03b0f34f29779570e642644a4e33418702425d5)  
