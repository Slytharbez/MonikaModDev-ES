...
label monika_event_clothes_select:
    ...
    python:
        mailbox = store.mas_selspr.MASSelectableSpriteMailbox(
            renpy.translation.translate_string(_("Do you want me to change?"))
        )
...
#        use_remover = not monika_chr.is_wearing_hair_with_exprop("force-ribbon")
        ...
        mailbox = store.mas_selspr.MASSelectableSpriteMailbox(
            renpy.translation.translate_string(_("Which hair tie would you like me to use?"))
        )
        sel_map = {}
...
label monika_hairflower_select:
    python:
        ...
        mailbox = store.mas_selspr.MASSelectableSpriteMailbox(
            renpy.translation.translate_string(_("Which flower would you like me to put in my hair?"))
        )
        sel_map = {}
