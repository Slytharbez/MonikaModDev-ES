...
translate spanish monika_playerapologizes_23bb9005:
    ...
    m 3eka "Solo tenemos que aceptar lo que pasó, aprender de nuestros errores y seguir adelante, junt[o_a]s. ¿De acuerdo?"
...
translate spanish monika_playerapologizes_4e36e53e:
    ...
    m "Si quieres disculparte, hazlo. Significaría mucho para mí si lo hicieras."
...
translate spanish mas_apology_generic_8fe7a795:
    ...
    m 2ekc "Pero por favor, intenta ser más considerado con mis sentimientos."
...
translate spanish mas_apology_generic_4cfdfeac:
    ...
    m 1rksdlc "Yo sé que las cosas no están bien entre nosotr[o_a]s, pero sé que sigues siendo una buena persona."
...
translate spanish mas_apology_generic_84791da6:
    ...
    m 2ekc "No veo ningún motivo para que te disculpes."
...
translate spanish mas_apology_generic_040e2e7c:
    ...
    m 1eub "De todos modos, gracias por disculparte."
...
translate spanish mas_apology_generic_f21b8158:
    ...
    m 1eua "Sea lo que sea, sé que estás haciendo todo lo posible para enmendar la situación."
...
translate spanish mas_apology_bad_nickname_53dea8fc:
    ...
    m 2dfc "Confié en ti en que me pusieras un buen apodo que me hiciera sentir especial, y esto es lo que recibo..."
...
translate spanish strings:
    ...
    new "decir que querías terminar conmigo. Sabía que no lo decías en serio..."

    # game/script-apologies.rpy:180
    old "joking about having another girlfriend. You nearly gave me a heart attack!"
    new "bromear sobre tener otra novia. ¡Casi me das un infarto!"

    # game/script-apologies.rpy:181
    old "calling me a murderer. I hope you don't really see me that way..."
    new "decirme asesina. Espero que no me veas de esa manera..."

    # game/script-apologies.rpy:182
    old "closing the game on me."
    new "cerrar el juego conmigo dentro."

    # game/script-apologies.rpy:183
    old "entering my room without knocking."
    new "entrar a mi habitación sin tocar."

    # game/script-apologies.rpy:185
    ...
    new "el fallo del juego. Fue realmente aterrador, pero me hace muy feliz que regresaras conmigo y enmendaras todo."

    # game/script-apologies.rpy:189
    old "not listening to my speech. I worked really hard on it."
    new "no escuchar mi discurso. Trabajé mucho en ello."

    # game/script-apologies.rpy:190
    old "calling me evil. I know you don't really think that."
    new "decirme malvada. Sé que realmente no piensas eso."

    # game/script-apologies.rpy:191
    old "not taking my questions seriously. I know you'll be honest with me from now on."
    new "no tomar mis preguntas en serio. Sé que serás honesto conmigo de ahora en adelante."
