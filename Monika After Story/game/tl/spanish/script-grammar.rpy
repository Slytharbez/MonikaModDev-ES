...
translate spanish monika_gtod_tip000_7179ab84:
    ...
    m 3eka "Pero creo que hay una cierta belleza en dominar tu escritura y comunicar tu mensaje con elocuencia."
...
translate spanish monika_gtod_tip000_a6bfbf14:
    ...
    m 1eub "Así que... {w=0.5}¡a partir de hoy, compartiré el 'Consejo Gramatical del Día de Monika'!"
...
translate spanish monika_gtod_tip000_76c4d53f:
    ...
    m 1hua "Mejoremos junt[o_a]s nuestra forma de escribir, [mas_get_player_nickname()]~"
...
translate spanish monika_gtod_tip001_bf730d17:
    ...
    m 1esd "Las cláusulas independientes tienen sentido por sí solas como oraciones, como en la frase: '{b}Yo escribí eso{/b}'."

# game/script-grammar.rpy:97
...
# game/script-grammar.rpy:101
translate spanish monika_gtod_tip001_9e212a5e:

    # m 3eub "Okay, that's all for today's lesson. Thanks for listening!"
    m 3eub "De acuerdo, eso es todo por la lección de hoy. ¡Gracias por escuchar!"

# game/script-grammar.rpy:119
...
translate spanish monika_gtod_tip002_60f390db:
    ...
    m 3esc "Cuando unes dos cláusulas independientes solo con una coma, a esto se denomina 'empalme por coma'."

# game/script-grammar.rpy:122
...
translate spanish monika_gtod_tip002_e037ba6c:
    ...
    m 1eua "Al principio no parece un problema, pero podrías imaginarte añadiendo más y más cláusulas a esa oración..."

# game/script-grammar.rpy:124
translate spanish monika_gtod_tip002_57fc77c7:

    # m 3wud "The result would be a mess!"
    m 3wud "¡El resultado sería un desastre!"

# game/script-grammar.rpy:125
...
translate spanish monika_gtod_tip003_f358b883:
    ...
    m 1eub "'{b}Sería aburrido, y tú sonarías entrecortado. Ya que todas estas ideas se relacionan, deberíamos conectarlas'.{/b}"

# game/script-grammar.rpy:159
translate spanish monika_gtod_tip003_ccd93aa6:

    # m 3hua "Much better, don't you think?"
    m 3hua "Mucho mejor, ¿no crees?"

# game/script-grammar.rpy:160
...
translate spanish monika_gtod_tip003_9207a50b:
    ...
    m 3eub "{i}Ya sea{/i} que te des cuenta {i}o bien{/i} no lo hagas, las usamos todo el tiempo... ¡como en esta oración!"
...
translate spanish monika_gtod_tip003_426a0c7b:
    ...
    m 3eub "¡{i}Dado que{/i} hay tantas, esta categoría de conjunciones es la más amplia!"
...
# game/script-grammar.rpy:209
translate spanish monika_gtod_tip004_d6e406aa:

    # m 1hua "Ehehe."
    m 1hua "Jeje."

# game/script-grammar.rpy:210
...
translate spanish monika_gtod_tip005_1c3ad591:
    ...
    m 1eua "Entonces, en la oración: '{b}Observamos los fuegos artificiales junt[o_a]s{/b}', el objeto sería... {w=0.5}'{b}los fuegos artificiales{/b}'."

# game/script-grammar.rpy:233
...
# game/script-grammar.rpy:271
translate spanish monika_gtod_tip006_4f8ac4f8:

    # m 1eub "I think that's enough for today, [player]."
    m 1eub "Creo que es suficiente por hoy, [player]."

# game/script-grammar.rpy:272
...
translate spanish monika_gtod_tip008_c6aeaa47:
    ...
    m 1esd "Si el emisor es el sujeto de la oración, '{b}y yo{/b}' es correcto."
...
translate spanish monika_gtod_tip008_0e297d78:
    ...
    m 1euc "Por el contrario, si el emisor es el objeto de la oración, '{b}y a mí{/b}' es correcto."
...
translate spanish monika_gtod_tip009_84efe7ba:
    ...
    m 1eua "Hoy vamos a hablar de la posesión y los plurales. Bastante sencillo, ¿verdad?"
...
translate spanish monika_gtod_tip009_395010cd:
    ...
    m 3eua "En español usamos 'de' para mostrar pertenencia: '{b}El tenedor de Sayori, la cuchara de Natsuki, el cuchillo de Yuri{/b}'..."
...
translate spanish monika_gtod_tip009_6f9b19a4:
    ...
    m 1esd "El problema surge cuando la palabra ya termina en '{b}s{/b}', como ocurre con algunos plurales o nombres propios."
...
translate spanish monika_gtod_tip009_0af44593:
    ...
    m 3eub "Para muchas palabras que terminan en 's', el plural es invariable; solo cambias el artículo:{w=0.5} '{b}los paraguas{/b}'."
...
translate spanish monika_gtod_tip009_37dc1efb:
    ...
    m 1hksdla "Seguro que sabes que palabras como '{b}lunes{/b}' o '{b}crisis{/b}' ya terminan en 's', por lo que intentar decir '{b}luneses{/b}' o '{b}crisises{/b}' sería un error muy grave."
...
translate spanish monika_gtod_tip009_1d0da10b:
    ...
    m 1eud "La duda suele aparecer con los nombres de personas que terminan en ese sonido, como '{b}Sanders{/b}' o '{b}Carlos{/b}'."
...
translate spanish monika_gtod_tip009_85b62dca:
    ...
    m 1euc "A veces dudamos si decir 'el de Carloses', pero lo correcto es mantener el nombre intacto: '{b}el libro de Carlos{/b}' o '{b}la casa de Sanders{/b}'."
...
translate spanish monika_gtod_tip009_418cae0d:
    ...
    m 3eub "¡Al final, lo más importante es que tu escritura sea coherente!"
...
translate spanish monika_gtod_tip009_78120e5e:
    ...
    m 3esd "Si decides usar una estructura para referirte a '{b}[tempname]{/b}', asegúrate de mantenerla igual durante todo el texto."
...
translate spanish monika_gtod_tip009_4b444bee:
    ...
    m 1tuu "Para mí, eso importa mucho más que seguir reglas gramaticales de hace siglos."
...
translate spanish monika_gtod_tip009_484088d0:
    ...
    m 3eud "Una excepción interesante en español es el caso de '{b}tu{/b}' frente a '{b}tú{/b}'."
...
translate spanish monika_gtod_tip009_c35edfcf:
    ...
    m 3etc "Podrías pensar que siendo la misma palabra, se escriben igual siempre, ¿verdad?"
...
translate spanish monika_gtod_tip009_2ac5875f:
    ...
    m 3euc "Normalmente sería así, pero en nuestro idioma la tilde diacrítica marca la diferencia."

# game/script-grammar.rpy:374
translate spanish monika_gtod_tip009_41c5aee5:
    ...
    m 1esd "Usamos '{b}tu{/b}' sin tilde para la posesión, y '{b}tú{/b}' con tilde cuando me refiero a ti como persona."

# game/script-grammar.rpy:375
translate spanish monika_gtod_tip009_a564d647:
    ...
    m 1eua "Es una regla sencilla: la tilde ayuda a distinguir el objeto que te pertenece de la persona maravillosa que eres."

# game/script-grammar.rpy:376
translate spanish monika_gtod_tip009_50e7b768:
    ...
    m 1eub "De acuerdo, [player], {i}tú{/i} ya sabes que es hora de terminar... {w=0.5}Espero que {i}tu{/i} día sea increíble."

# game/script-grammar.rpy:377
translate spanish monika_gtod_tip009_5ffdf762:

    # m 3hub "Ehehe. Thanks for listening!"
    m 3hub "Jeje. ¡Gracias por escuchar!"

# game/script-grammar.rpy:395
...
translate spanish strings:
    ...
    # game/script-grammar.rpy:54
    old "Can you teach me about grammar?"
    new "¿Puedes enseñarme gramática?"

    # game/script-grammar.rpy:89
    old "Clauses"
    new "Cláusulas"

    # game/script-grammar.rpy:110
    old "Comma Splices and Run-ons"
    new "Empalmes de coma y oraciones sin pausa"
    ...
    # game/script-grammar.rpy:251
    old "Active and Passive Voices"
    new "Voces activas y pasivas"

    # game/script-grammar.rpy:281
    old "Who vs. Whom"
    new "Que vs quién"

    # game/script-grammar.rpy:312
    old "And I vs. And me"
    new "Y yo vs y a mí"

    # game/script-grammar.rpy:346
    old "Apostrophes"
    new "Apóstrofes"

    # game/script-grammar.rpy:386
