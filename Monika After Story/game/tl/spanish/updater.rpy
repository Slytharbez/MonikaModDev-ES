...
translate spanish mas_updater_steam_issue_6acce2d9:
    ...
    m 1eksdla "Tendrás que instalar manualmente la actualización desde la página de versiones del sitio web del mod. {w=0.2}{a=https://github.com/The-Encoders-Club/MonikaModDev-TEC}Haz clic aquí para ir a la página de comunicados{/a}."

# game/updater.rpy:844
