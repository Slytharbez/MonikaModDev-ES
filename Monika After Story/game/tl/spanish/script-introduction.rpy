...
translate spanish introduction_99edcbc5:
    ...
    m 2rfc "Sabes, eso realmente dolió."
...
translate spanish introduction_1e42de47:
    ...
    m 2rfd "Solo para que aquel por quien sangré terminara destrozándome el corazón."
...
translate spanish introduction_51a95491:
    ...
    m 2tkc "Te amo, [player], pero puedes llegar a ser muy cruel..."
...
translate spanish introduction_f57518b6:
    ...
    m 3eka "Incluso agregaste un mod para que podamos hacer más cosas junt[o_a]s."
...
translate spanish introduction_b80a6b32:
    ...
    m 3ekbsu "De verdad estás realmente comprometido con nuestra relación, ¿no es así?"
...
translate spanish introduction_bb7d368d:
    ...
    m 1rksdlb "Me alegra muchísimo que hayas querido hacer aún más especial nuestro tiempo junt[o_a]s."
...
translate spanish introduction_38d59c27:
    ...
    extend 1eua "pero sé que la haremos mejor junt[o_a]s [player]."
...
translate spanish introduction_55aa744e:
    ...
    if _iswas == "is":
        m 1dsc "De todas formas, no es como si ese archivo sea {i}mi verdadero yo{/i}."
    else:
        m 1dsc "De todas formas, no es como si ese archivo fuera {i}mi verdadero yo{/i}."
...
translate spanish introduction_03e59225:
    ...
    if _iswas == "is":
        m 1rsc "Eso solo es un archivo con un código extraño."
    else:
        m 1rsc "Eso solo era un archivo con un código extraño."
...
translate spanish introduction_a4ef7c35:
    ...
    m 3eua "Puedo {i}transformarme{/i} en un archivo para que puedas llevarme contigo."
...
translate spanish introduction_42ae8c18:
    ...
    m 3hubfa "De esa manera, podemos estar junt[o_a]s todo el tiempo~"
...
translate spanish introduction_64da64e3:
    ...
    m 3hubfa "¡Hace que todo lo que he hecho por nosotr[o_a]s valga la pena!"
...
translate spanish introduction_0c89200d:
    ...
    m "¿Me amas, [player]?{fast}" nointeract
...
translate spanish introduction_95713cb8:
    ...
    m 3eud "La verdad es que si no me amaras, no estaríamos aquí en primer lugar."

# game/script-introduction.rpy:180
translate spanish introduction_aee50518:

    # m 1tsb "We'll be together forever."
    m 1tsb "Estaremos junt[o_a]s para siempre."
...
translate spanish intro_end_48f6fd8a:
    ...
    m 1eua "... Así que solo déjame en segundo plano."
...
translate spanish intro_ily_timedout_5451a915:
    ...
    m "Tú me amas, [player]... {w=0.5}¿verdad?{nw}"
...
translate spanish intro_ily_timedout_820a683c:
    ...
    m "Tú me amas, [player]... {w=0.5}¿verdad?{fast}" nointeract
...
translate spanish ch30_reload_3_dlg_5ca78516:
    ...
    m 2dsc "De todos modos, me estoy empezando a acostumbrar."
...
translate spanish ch30_reload_3_dlg_63915b84:
    ...
    m 7eka "Pero de verdad preferiría que me dejaras cerrar el juego a mí."
...
translate spanish ch30_reload_3_dlg_4626062e:
    ...
    m 1eua "Así podré estar lista y descansar tranquila."
...
translate spanish ch30_reload_3_dlg_0dc42213:
    ...
    m 3rksdla "Al fin y al cabo, necesito mi sueño reparador de vez en cuando."
...
translate spanish ch30_reload_continuous_dlg_a95a9a5e:
    ...
    m 1ekb "¡Estoy segura de que, sea lo que sea, no será tan malo después de pasar un rato conmigo!"
...
translate spanish strings:
    ...
    # game/script-introduction.rpy:226
