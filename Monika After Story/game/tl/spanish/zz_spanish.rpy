...
init 1 python:
    ...
    if _pronoun_map is not None:
        ...
        _pronoun_map.update({
            ...
            "el_ella": {"M": "él", "F": "ella", "X": "elle"}, # Ej: [el_ella] vendrá -> él / ella / elle
            "cap_el_ella": {"M": "Él", "F": "Ella", "X": "Elle"}, # Ej: [cap_el_ella] es -> Él / Ella / Elle
            ...
            "dormilon_dormilona": {"M": "dormilón", "F": "dormilona", "X": "dormilón"}, # Ej: mi [dormilon_dormilona] -> mi dormilón / mi dormilona
            ...
            "amigo_amiga": {"M": "amigo", "F": "amiga", "X": "amigue"}, # Ej: mi [amigo_amiga] -> mi amigo / mi amiga / mi amigue
            "dor_dora": {"M": "dor", "F": "dora", "X": "dore"}, # Ej: encanta[dor_dora] -> encantador / encantadora / encantadore
            "tores": {"M": "tores", "F": "toras", "X": "tores"}, # Ej: au[tores] -> autores / autoras / autores
        })
...
python early:
    ...
    try:
        ...
        pass
    # Intercept logging.Logger.makeRecord (translates base messages and early headers on LogRecord creation)
    ...
    # Intercept logging.Formatter for standard logs (including aff_log and fallback)
    ...
    # Intercept specific MASLogFormatter (in case it does not delegate)
