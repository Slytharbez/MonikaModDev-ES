...
translate spanish monika_fun_facts_open_4515a3e6:
    ...
    m 1eub "Estuve buscando datos curiosos para que aprendamos algo nuevo l[o_a]s dos."

# game/script-fun-facts.rpy:49
...
translate spanish monika_fun_facts_open_563919c2:
    ...
    m 1rksdla "Encontré la mayoría de estos en internet, así que no puedo afirmar que sean {i}definitivamente{/i} verdaderos..."
...
translate spanish mas_fun_fact_librocubiculartist_a17c1253:
    ...
    m 3eud "Pero si dices esa palabra, la mayoría de las personas no sabrían de qué estás hablando."
...
translate spanish mas_fun_fact_librocubiculartist_f70fbc9e:
    ...
    m 2hksdlb "... Jeje, lo siento [player]. No quise molestarme tanto~"

# game/script-fun-facts.rpy:118
...
translate spanish mas_fun_fact_love_you_1368a01d:
    ...
    m 1rksdlb "Jeje, lo siento, no pude evitarlo."
...
translate spanish mas_fun_fact_morpheus_9fd773f0:
    ...
    m 4rksdlb "Ya es muy tarde para cambiarlo, supongo."

# game/script-fun-facts.rpy:181
...
translate spanish mas_fun_fact_chess_a69f4220:
    ...
    m 1hua "¿Quieres jugar una partida de ajedrez conmigo? Incluso podría ser amable contigo, jeje~"

# game/script-fun-facts.rpy:218
translate spanish mas_fun_fact_chess_581820c1:

    # m 1dsc "Chess..."
    m 1dsc "Ajedrez..."

# game/script-fun-facts.rpy:219
translate spanish mas_fun_fact_chess_01a93df6:

    # m 2dfc "..."
    m 2dfc "..."

# game/script-fun-facts.rpy:220
...
# game/script-fun-facts.rpy:287
translate spanish mas_fun_fact_vincent_van_gone_44eed7be:

    # m 1dsc "Ah, this one..."
    m 1dsc "Ah, este..."

# game/script-fun-facts.rpy:288
...
# game/script-fun-facts.rpy:312
translate spanish mas_fun_fact_king_snakes_aee3d749:

    # m 1dsc "Hmm..."
    m 1dsc "Hmm..."

# game/script-fun-facts.rpy:313
...
translate spanish mas_fun_fact_strength_bb85eda7:
    ...
    m 3eub "Una de las palabras en español que solo tiene una misma vocal es 'abrazar'."

# game/script-fun-facts.rpy:334
translate spanish mas_fun_fact_strength_f5033e59:
    ...
    m 1eua "Es curioso cómo de cada palabra del idioma, es una palabra tan significativa que tenía ese pequeño detalle."

# game/script-fun-facts.rpy:335
...
translate spanish mas_fun_fact_strength_df127fcd:
    ...
    m 3eua "¿Quieres saber qué viene a mi mente cuando pienso en la palabra 'abrazar'?"
...
translate spanish mas_fun_fact_strength_9e9e2b4d:
    ...
    m 1hub "Porque tus abrazos son los que me dan fuerza, jeje~"

# game/script-fun-facts.rpy:353
translate spanish mas_fun_fact_reindeer_eyes_8a6d8171:

    # m 3eua "Ready for this one?"
    m 3eua "¿List[o_a] para este?"

# game/script-fun-facts.rpy:354
...
translate spanish mas_fun_fact_reindeer_eyes_de921831:
    ...
    m 3hksdlb "¿Quizás puedas buscarla tú mism[o_a]?"
...
translate spanish mas_fun_fact_bananas_b73301d5:
    ...
    m 1dsc "Mejor continuemos..."

# game/script-fun-facts.rpy:402
...
translate spanish mas_fun_fact_pens_983d1bad:
    ...
    m 3euc "Solo hasta el siglo XIX, cuando se fabricaron los bolígrafos de metal, los otros empezaron a decaer."
...
# game/script-fun-facts.rpy:423
translate spanish mas_fun_fact_density_435618ef:

    # m 1eub "Ooh, I know."
    m 1eub "Oh, ya sé."

# game/script-fun-facts.rpy:424
...
# game/script-fun-facts.rpy:447
translate spanish mas_fun_fact_binky_e2dbbb2d:

    # m 3hua "Whenever a rabbit hops around excitedly, it's called a binky!"
    m 3hua "¡El salto que dan los conejos cuando están muy emocionados se conoce como 'binky'!"

# game/script-fun-facts.rpy:448
translate spanish mas_fun_fact_binky_030c3e1b:

    # m 1hua "Binky is such a cute sounding word, it really does suit the action."
    m 1hua "Binky es una palabra del inglés que suena tan linda que realmente se adapta a la acción."
...
translate spanish mas_fun_fact_binky_fc483830:
    ...
    m 1rksdlb "¡No esperes que empiece a dar saltitos, [player]!"
...
translate spanish mas_fun_fact_photography_0c9ea00b:
    ...
    m 3eud "Se usaban reveladores, baños de paro y fijadores químicos solo para procesar el papel en el que se imprimían las fotos... {w=0.3}{nw}"
...
translate spanish mas_fun_fact_getting_older_4dac0c21:
    ...
    m 1eka "Así que siempre apreciaré nuestros momentos junt[o_a]s, sin importar cuán largos o cortos sean."
...
translate spanish mas_fun_fact_dancing_plague_f086edd7:
    ...
    m 1eua "Aparentemente, Europa fue afectada por brotes de una 'epidemia de baile' en el pasado."

# game/script-fun-facts.rpy:623
translate spanish mas_fun_fact_dancing_plague_58136a4b:
    ...
    m 3wud "Las personas, {w=0.2}a veces cientos a la vez, {w=0.2}bailaban involuntariamente durante días, ¡algunos incluso morían de agotamiento!"

# game/script-fun-facts.rpy:624
...
translate spanish mas_fun_fact_dancing_plague_9bafb93d:
    ...
    m 3hksdlb "Supongo que, ¡la realidad realmente es más extraña que la ficción!"
...
translate spanish mas_fun_fact_dancing_plague_b8e8f752:
    ...
    m 3tsu "... Sol[o_a] por un rato, jeje~"

# game/script-fun-facts.rpy:647
...
translate spanish mas_fun_fact_pando_forest_5fae84a4:
    ...
    m 3eua "Se llama el bosque de Pando, y en sus 43 hectáreas, sus troncos están conectados por un solo sistema de raíces."

# game/script-fun-facts.rpy:649
...
translate spanish mas_fun_fact_pando_forest_c56a60f0:
    ...
    m 1ruc "'Un solo organismo que se convirtió en un ejército de clones por sí mismo, todos conectados a la misma mente colmena'."
...
# game/script-fun-facts.rpy:668
translate spanish mas_fun_fact_immortal_jellyfish_53cb25fd:

    # m 3eub "Here's one!"
    m 3eub "¡Aquí hay uno!"

# game/script-fun-facts.rpy:669
...
translate spanish mas_fun_fact_antarctica_brain_9b0c0bd2:
    ...
    m 3eka "Me encanta estar contigo [player], y espero que podamos seguir hablando así en el futuro. {w=0.2}[dlg_line!t]"

# game/script-fun-facts.rpy:751
...
translate spanish mas_fun_fact_cloud_weight_7e1d025d:
    ...
    m 1tua "Lo más probable es que ya conozcas la respuesta, ¿verdad [player]? Jeje~"

# game/script-fun-facts.rpy:771
...
translate spanish mas_fun_fact_synesthesia_e3b6a243:
    ...
    m 1hua "Esa es una explicación bastante confusa, jeje... {w=0.2}¡busquemos un ejemplo!"

# game/script-fun-facts.rpy:805
...
translate spanish mas_fun_fact_monochrome_dreams_c04ac450:
    ...
    m 3eua "Creo que si hay una lección que aprender aquí, es que debemos tener mucho cuidado con el tipo de contenido que consumimos, ¿de acuerdo, [player]?"

# game/script-fun-facts.rpy:868
translate spanish mas_fun_fact_round_earth_a6309de3:

    # m 1rsa "Hmm..."
    m 1rsa "Hmm..."

# game/script-fun-facts.rpy:869
...
translate spanish mas_fun_fact_round_earth_fc7a515c:
    ...
    m 3esd "Aristóteles sostuvo que la Tierra era redonda en el siglo IV a. C."
...
translate spanish strings:
    ...
    # game/script-fun-facts.rpy:40
    old "Can you tell me a fun fact?"
    new "¿Puedes decirme un dato curioso?"

    # game/script-fun-facts.rpy:719
    old "But make sure you keep up with your "
    new "Pero asegúrate de mantenerte al día con "

    # game/script-fun-facts.rpy:722
    old "family and friends too, okay?"
    new "tu familia y amigos, ¿de acuerdo?"

    # game/script-fun-facts.rpy:725
    old "family too, okay?"
    new "tu familia, ¿de acuerdo?"

    # game/script-fun-facts.rpy:728
    old "friends too, okay?"
    new "tus amigos, ¿de acuerdo?"

    # game/script-fun-facts.rpy:731
    old "Just be sure you find some people to talk to in your reality too, okay?"
    new "Solo asegúrate de encontrar algunas personas con las que hablar en tu realidad, ¿de acuerdo?"

    # game/script-fun-facts.rpy:871
    old "Round."
    new "Redonda."
