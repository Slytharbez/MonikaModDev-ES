...
translate spanish game_pong_3597d451:
    ...
    m 2tfb "¡Dame lo mejor de ti, [mas_get_player_nickname(regex_replace_with_nullstr='mi ')]!"

# game/pong.rpy:487
translate spanish game_pong_ac38c54c:

    # m 1hua "You want to play pong again?"
    m 1hua "¿Quieres jugar al pong otra vez?"
...
translate spanish mas_pong_dlg_winner_b7fb763f:
    ...
    m 1hksdla "Sé que te pedí que fueras amable conmigo, pero esto no es lo que tenía en mente..."

# game/pong.rpy:621
translate spanish mas_pong_dlg_winner_2dd452cd:

    # m 3eka "I do appreciate the gesture though~"
    m 3eka "Aun así, agradezco el gesto~"

# game/pong.rpy:626
translate spanish mas_pong_dlg_winner_da20386e:

    # m 1hub "Yay, I won!"
    m 1hub "¡Yey, he ganado!"
...
translate spanish mas_pong_dlg_winner_d2dee365:
    ...
    m 2hksdlb "¡Deja de burlarte de mí!"
...
translate spanish mas_pong_dlg_winner_390096ac:
    ...
    m 3eub "Jugar contra ti es todo un desafío, [player]."
...
translate spanish mas_pong_dlg_winner_7f98eaa4:
    ...
    m 3hub "Bien jugado, [player], ¡eres realmente buen[o_a]!"
...
translate spanish mas_pong_dlg_winner_5fd8aa55:
    ...
    m 1hksdlb "¡Lo siento por eso, [player]!"
...
translate spanish mas_pong_dlg_winner_7a7846ac:
    ...
    m 2tsb "¿Acaso juego demasiado bien para ti?"
...
translate spanish mas_pong_dlg_sorry_assuming_d8384ddb:
    ...
    m "¿Te gustaría tomar un descanso, [player]?{fast}" nointeract
...
translate spanish mas_pong_dlg_sorry_assuming_140aa56a:
    ...
    m 1eua "Avísame cuando estés list[o_a] para jugar de nuevo."

# game/pong.rpy:887
translate spanish mas_pong_dlg_sorry_assuming_8ea21225:

    # m 1eka "Alright, [player]. If you're sure."
    m 1eka "Muy bien, [player]. Si estás segur[o_a]."
...
translate spanish mas_pong_dlg_loser_0a10b185:
    ...
    m 2tsu "Ahora estamos jugando en serio, ¿eh?~"

# game/pong.rpy:920
translate spanish mas_pong_dlg_loser_034ba3fa:

    # m 2tfu "Let's find out how good you really are, [player]!"
    m 2tfu "¡Averigüemos qué tan buen[o_a] eres realmente, [player]!"
...
translate spanish mas_pong_dlg_loser_9963f134:
    ...
    m 4eua "Recuerda, ¡si practicas lo suficiente estoy segura de que podrás alcanzar todo lo que te propongas!"
...
translate spanish mas_pong_dlg_loser_b49d275c:
    ...
    m 1hua "Me alegra que hayas ganado esta vez, [player]."
...
translate spanish mas_pong_dlg_loser_ae4b017c:
    ...
    m 2hksdlb "¡Era imposible que le diera a eso!"

# game/pong.rpy:949
translate spanish mas_pong_dlg_loser_9b13d6ee:

    # m 2wuo "Wow, that was a great shot!"
    m 2wuo "¡Wow, eso fue un tiro estupendo!"
...
translate spanish mas_pong_dlg_loser_524d358e:
    ...
    m 2tsu "Tal vez deba empezar a jugar más en serio~"

# game/pong.rpy:964
translate spanish mas_pong_dlg_loser_7cb60571:

    # m 4hua "You're pretty good!"
    m 4hua "¡Eres bastante buen[o_a]!"
...
translate spanish mas_pong_dlg_loser_3daf84ae:
    ...
    m 1eua "Es agradable verte ganar, [player]."
...
translate spanish mas_pong_dlg_loser_1f85fd53:
    ...
    m 1hub "¡Has vuelto a ganar! {w=0.2}Bien hecho~"

# game/pong.rpy:1030
translate spanish mas_pong_dlg_loser_1b2e9934:

    # m 1eua "You won! {w=0.2}Not bad."
    m 1eua "¡Has ganado! {w=0.2}No está mal."
...
translate spanish mas_pong_dlg_winner_end_d5b8a9ec:
    ...
    m 4tku "No puedo emocionarme mucho con un juego tan simple..."

# game/pong.rpy:1102
translate spanish mas_pong_dlg_winner_end_8bbfefee:

    # m 1eua "But at least it's still fun to play."
    m 1eua "Pero al menos sigue siendo divertido jugar."
...
translate spanish strings:
    ...
    new "¿Me estás dejando ganar a propósito otra vez?"

    # game/pong.rpy:650
    old "Are you letting me win on purpose?"
    new "¿Me estás dejando ganar a propósito?"
